...
class Driver(Module):
    ...
    def __init__(self):
        ...
        self.occupy_reg_array = RegArray(Bits(5), len(Instructions), [x[0] for x in Instructions])
        self.release_reg_array = RegArray(Bits(5), len(Instructions), [x[1] for x in Instructions])
